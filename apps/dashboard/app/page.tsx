...
import { Notifications, NotificationItem } from "../components/home/Notifications";
...
export default function DashboardPage() {
 const [selectedItem, setSelectedItem] = useState<ContentItem | null>(null);
  ...
  const contentItems: ContentItem[] = [
    {
      ...
      subtitle: "Monthly Content Calendar • Facebook Posting Schedule • 30 reels ideas",
  ...
  },
  {
    ...
    description: "You’ve assigned/downloaded the project to concerned freelancers.",
...
<ContentList items={contentItems} onItemClick={(item) => setSelectedItem(item)} />
